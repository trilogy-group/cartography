...
def load_network_interfaces(neo4j_session, data, region, aws_account_id, aws_update_tag):
    ...
    UNWIND {network_interfaces} AS network_interface
        ...
        SET netinf.lastupdated = {aws_update_tag},
            ...
            netinf.public_dns_name = network_interface.Association.PublicDnsName,
            netinf.vpc_id = network_interface.VpcId,
            netinf.instanceid = network_interface.Attachment.InstanceId,
            netinf.region = {region},
            netinf.interface_type = network_interface.InterfaceType,
            netinf.availability_zone = network_interface.AvailabilityZone,
