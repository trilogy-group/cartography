...
from .volumes import sync_volumes
...
def sync(neo4j_session, boto3_session, regions, account_id, sync_tag, common_job_parameters):
    ...
    sync_network_acls(neo4j_session, boto3_session, regions, account_id, sync_tag, common_job_parameters)
    sync_load_balancer_v2s(neo4j_session, boto3_session, regions, account_id, sync_tag, common_job_parameters)
    sync_volumes(neo4j_session, boto3_session, regions, account_id, sync_tag, common_job_parameters)
